...
fn main() {
  ...
  if !object_path.exists() {
    panic!("\x1b[34mA Core component of building skirk was not found. Aborting.\x1b[0m");
    panic!("\x1b[34mA If this installation was from cargo, please report this issue to the repository at https://github.com/aitzazisstuffed/skirk/issues.\x1b[0m");
  }
